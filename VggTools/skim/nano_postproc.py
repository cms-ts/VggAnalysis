...
if __name__ == "__main__":
    ...
    parser.add_option("-P", "--provenance",  dest="provenance", default=False, action="store_true",  help="Save provenance")
    ...
    p=PostProcessor(outdir,args,options.cut,options.branchsel_in,modules,options.compression,options.friend,options.postfix,options.json,options.noOut,options.justcount,options.provenance,outputbranchsel= options.branchsel_out)
    p.run()
