...
for D1 in `ls $DATADIR/ | grep Run2016`; do
  for D2 in `ls $DATADIR/$D1`; do
    ...
    python nano_report.py -o logs/${D1}_${D2}_05Feb2018.json \
...
for D1 in `ls $DATADIR/ | grep Run2016`; do
  for D2 in `ls $DATADIR/$D1`; do
    ...
    echo "checking ${D1}/${D2} - $N files"
    python nano_report.py -o logs/${D1}_${D2}_22Aug2018.json \
...
for D1 in `ls $DATADIR/ | grep Run2017`; do
  for D2 in `ls $DATADIR/$D1`; do
    ...
    echo "checking ${D1}/${D2} - $N files"
    python nano_report.py -o logs/${D1}_${D2}_31Mar2018.json \
...
for D1 in `ls $DATADIR/ | grep Run2018`; do
  for D2 in `ls $DATADIR/$D1`; do
    ...
    echo "checking ${D1}/${D2} - $N files"
    python nano_report.py -o logs/${D1}_${D2}_14Sep2018.json \
...
for D2 in `ls $DATADIR/Run2016B/`; do
  ...
  python nano_report.py -o logs/Run2016_${D2}_05Feb2018.json \
...
for D2 in `ls $DATADIR/Run2016B/`; do
  ...
  echo "checking Run2016/${D2} - $N files"
  python nano_report.py -o logs/Run2016_${D2}_22Aug2018.json \
...
for D2 in `ls $DATADIR/Run2017B/`; do
  ...
  python nano_report.py -o logs/Run2017_${D2}_31Mar2018.json \
...
for D2 in `ls $DATADIR/Run2018B/`; do
  ...
  python nano_report.py -o logs/Run2018_${D2}_14Sep2018.json \
