...
namespace Rivet {
  ...
  class CMS_SMP_19_067 : public Analysis {
    public:

    /// Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(CMS_SMP_19_067);
    ...
    void init() {
      ...
      _h_ZGG_ele_pho0_pho1_pt = bookHisto1D("h_ZGG_ele_pho0_pho1_pt", 15, 0, 300);
      _h_ZGG_muo_pho0_pho1_pt = bookHisto1D("h_ZGG_muo_pho0_pho1_pt", 15, 0, 300);
    }
    ...
    void analyze(const Event& event) {
      ...
      if (zees.size() == 1) {
        _h_ZGG_ele_pho0_pho1_pt->fill((pho0+pho1).pt(), w);
      }
      if (zmumus.size() == 1) {
        _h_ZGG_muo_pho0_pho1_pt->fill((pho0+pho1).pt(), w);
      }
    }
  ...
  private:
    Histo1DPtr _h_nevt;
    Histo1DPtr _h_ZGG_ele_pho0_pho1_pt;
    Histo1DPtr _h_ZGG_muo_pho0_pho1_pt;
  };

  DECLARE_RIVET_PLUGIN(CMS_SMP_19_067);
}
