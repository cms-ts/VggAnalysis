...
process.source = cms.Source("PoolSource",
    # test run over ZGG MiniAOD signal sample	
    fileNames = cms.untracked.vstring('/store/mc/RunIIAutumn18MiniAOD/ZGGToLLGG_5f_TuneCP5_13TeV-amcatnlo-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/00000/B147B409-CDE4-284E-B849-13353149E84C.root')     
)
...
process.rivetAnalyzer.AnalysisNames = cms.vstring('CMS_SMP_19_067')
#process.rivetAnalyzer.AnalysisNames = cms.vstring('CMS_SMP_19_013_Z')
process.rivetAnalyzer.OutputFile = cms.string('outZGGanalysis.yoda')
...
process.newFilter = cms.EDFilter("PythiaFilter",
  ...
  MotherID = cms.untracked.int32(23)
)
