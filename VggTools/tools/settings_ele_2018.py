...
samplesDef = {
    'data'   : tnpSamples.TnP2018['data_Run2018A'].clone(),
    'mcNom'  : tnpSamples.TnP2018['DY_madgraph'].clone(),
    'mcAlt'  : tnpSamples.TnP2018['DY_amcatnlo'].clone(),
    'tagSel' : tnpSamples.TnP2018['DY_madgraph'].clone(),
}

## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.TnP2018['data_Run2018B'] )
samplesDef['data'].add_sample( tnpSamples.TnP2018['data_Run2018C'] )
samplesDef['data'].add_sample( tnpSamples.TnP2018['data_Run2018D'] )
