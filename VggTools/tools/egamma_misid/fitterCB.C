...
void fitterCB(int number, int year, bool isQCD, string syst) {
   ...
   model_fake_MC.plotOn(plot_fake_MC, RooFit::Components(CB_fake_MC), RooFit::LineColor(kGreen)) ;
   plot_fake_MC->Draw();
   ...
   model_fake_DT.plotOn(plot_fake_DT, RooFit::Components(CB_fake_DT), RooFit::LineColor(kGreen)) ;
   plot_fake_DT->Draw();
