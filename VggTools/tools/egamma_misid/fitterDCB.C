...
void fitterDCB(int number, int year, bool isQCD, string syst) {
   ...
   TFile * file_root = new TFile((file_root_name).c_str());
   TH1D * h_MC = (TH1D*)file_root->Get("h_MC");
   TH1D * h_DT = (TH1D*)file_root->Get("h_DT");

   h_WG_ele_ele0_pho0_fake_MC->Add(h_MC, -1);
   h_WG_ele_ele0_pho0_fake_DT->Add(h_DT, -1);

   string txt_param_title = "parameters_" + syst + "/param_DCB" + sqcd + "_";
   txt_param_title += std::to_string(year) + "_" + std::to_string(number) + ".txt";

   double DCBn1_fake_MC_val[3];
   double DCBn2_fake_MC_val[3];
   double DCBalpha1_fake_MC_val[3];
   double DCBalpha2_fake_MC_val[3];
   double DCBmean_fake_MC_val[3];
   double DCBsigma_fake_MC_val[3];

   double DCBn1_fake_DT_val[3];
   double DCBn2_fake_DT_val[3];
   double DCBalpha1_fake_DT_val[3];
   double DCBalpha2_fake_DT_val[3];
   double DCBmean_fake_DT_val[3];;
   double DCBsigma_fake_DT_val[3];

   ifstream txt_param;
   txt_param.open((txt_param_title).c_str());
   txt_param >> DCBn1_fake_MC_val[1] >> DCBn1_fake_MC_val[0] >> DCBn1_fake_MC_val[2];
   txt_param >> DCBn2_fake_MC_val[1] >> DCBn2_fake_MC_val[0] >> DCBn2_fake_MC_val[2];
   txt_param >> DCBalpha1_fake_MC_val[1] >> DCBalpha1_fake_MC_val[0] >> DCBalpha1_fake_MC_val[2];
   txt_param >> DCBalpha2_fake_MC_val[1] >> DCBalpha2_fake_MC_val[0] >> DCBalpha2_fake_MC_val[2];
   txt_param >> DCBmean_fake_MC_val[1] >> DCBmean_fake_MC_val[0] >> DCBmean_fake_MC_val[2];
   txt_param >> DCBsigma_fake_MC_val[1] >> DCBsigma_fake_MC_val[0] >> DCBsigma_fake_MC_val[2];

   txt_param >> DCBn1_fake_DT_val[1] >> DCBn1_fake_DT_val[0] >> DCBn1_fake_DT_val[2];
   txt_param >> DCBn2_fake_DT_val[1] >> DCBn2_fake_DT_val[0] >> DCBn2_fake_DT_val[2];
   txt_param >> DCBalpha1_fake_DT_val[1] >> DCBalpha1_fake_DT_val[0] >> DCBalpha1_fake_DT_val[2];
   txt_param >> DCBalpha2_fake_DT_val[1] >> DCBalpha2_fake_DT_val[0] >> DCBalpha2_fake_DT_val[2];
   txt_param >> DCBmean_fake_DT_val[1] >> DCBmean_fake_DT_val[0] >> DCBmean_fake_DT_val[2];
   ...
   RooRealVar DCBn1_fake_MC("DCBn1_fake_MC","DCBn1_fake_MC", DCBn1_fake_MC_val[1], DCBn1_fake_MC_val[0], DCBn1_fake_MC_val[2]);
   RooRealVar DCBn2_fake_MC("DCBn2_fake_MC","DCBn2_fake_MC", DCBn2_fake_MC_val[1], DCBn2_fake_MC_val[0], DCBn2_fake_MC_val[2]);
   RooRealVar DCBalpha1_fake_MC("DCBalpha1_fake_MC","DCBalpha1_fake_MC", DCBalpha1_fake_MC_val[1], DCBalpha1_fake_MC_val[0], DCBalpha1_fake_MC_val[2]);
   RooRealVar DCBalpha2_fake_MC("DCBalpha2_fake_MC","DCBalpha2_fake_MC", DCBalpha2_fake_MC_val[1], DCBalpha2_fake_MC_val[0], DCBalpha2_fake_MC_val[2]);
   RooRealVar DCBmean_fake_MC ("DCBmean_fake_MC", "DCBmean_fake_MC", DCBmean_fake_MC_val[1], DCBmean_fake_MC_val[0], DCBmean_fake_MC_val[2]);
   RooRealVar DCBsigma_fake_MC("DCBsigma_fake_MC","DCBsigma_fake_MC", DCBsigma_fake_MC_val[1], DCBsigma_fake_MC_val[0], DCBsigma_fake_MC_val[2]);
   ...
   if (nullchi) {
     fit_fake_MC = DCB_fake_MC.fitTo(data_fake_MC, RooFit::SumW2Error(kFALSE), RooFit::Range(40., 120.), RooFit::Save(kTRUE));
   } else {
     fit_fake_MC = DCB_fake_MC.chi2FitTo(data_fake_MC, RooFit::SumW2Error(kFALSE), RooFit::Range(40., 120.), RooFit::Save(kTRUE));
   }
   ...
   RooRealVar DCBn1_fake_DT("DCBn1_fake_DT","DCBn1_fake_DT", DCBn1_fake_DT_val[1], DCBn1_fake_DT_val[0], DCBn1_fake_DT_val[2]);
   RooRealVar DCBn2_fake_DT("DCBn2_fake_DT","DCBn2_fake_DT", DCBn2_fake_DT_val[1], DCBn2_fake_DT_val[0], DCBn2_fake_DT_val[2]);
   RooRealVar DCBalpha1_fake_DT("DCBalpha1_fake_DT","DCBalpha1_fake_DT", DCBalpha1_fake_DT_val[1], DCBalpha1_fake_DT_val[0], DCBalpha1_fake_DT_val[2]);
   RooRealVar DCBalpha2_fake_DT("DCBalpha2_fake_DT","DCBalpha2_fake_DT", DCBalpha2_fake_DT_val[1], DCBalpha2_fake_DT_val[0], DCBalpha2_fake_DT_val[2]);
   RooRealVar DCBmean_fake_DT ("DCBmean_fake_DT", "DCBmean_fake_DT", DCBmean_fake_DT_val[1], DCBmean_fake_DT_val[0], DCBmean_fake_DT_val[2]);
   ...
   DCB_fake_MC.plotOn(plot_fake_MC, RooFit::LineColor(kRed), RooFit::LineStyle(7), RooFit::Name("sgn_fake_MC"));
   ...
   DCB_fake_DT.plotOn(plot_fake_DT, RooFit::LineColor(kRed), RooFit::LineStyle(7), RooFit::Name("sgn_fake_DT"));
   ...
   string txt_title = syst + "/sf_data_DCB" + sqcd + "_";
