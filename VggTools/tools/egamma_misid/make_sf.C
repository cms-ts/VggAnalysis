...
void make_sf(int year, bool isQCD) {
  ...
  TFile * f_pileup_up = new TFile(("../../macros/html/egamma_v7/pileup_up/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
  TFile * f_pileup_down = new TFile(("../../macros/html/egamma_v7/pileup_down/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
  TFile * f_sf_pho_veto_up = new TFile(("../../macros/html/egamma_v7/sf_pho_veto_up/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
  TFile * f_sf_pho_veto_down = new TFile(("../../macros/html/egamma_v7/sf_pho_veto_down/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
  TFile * f_sf_pho_eff_up = new TFile(("../../macros/html/egamma_v7/sf_pho_eff_up/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
  TFile * f_sf_pho_eff_down = new TFile(("../../macros/html/egamma_v7/sf_pho_eff_down/final_data" + sqcd + "_TP_DCB_" + std::to_string(year) + ".root").c_str());
