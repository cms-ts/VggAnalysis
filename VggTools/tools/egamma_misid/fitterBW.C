...
void fitterBW(int number, int year, bool isQCD, string syst) {
   ...
   RooAddPdf  model_fake_MC("model_fake_MC","model_fake_MC",RooArgList(CMS_fake_MC,BW_fake_MC),bkgfrac_fake_MC) ;
   ...
   RooAddPdf  model_fake_DT("model_fake_DT","model_fake_DT",RooArgList(CMS_fake_DT,BW_fake_DT),bkgfrac_fake_DT) ;
   ...
   string txt_title = syst + "/sf_data_BW" + sqcd + "_";
   ...
   string txt_title2 = syst + "/sf_xsec_BW" + sqcd + "_";
