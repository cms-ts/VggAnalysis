...
samplesDef = {
    ...
    'mcNom'  : tnpSamples.TnP2017['DY_madgraph'].clone(),
    'mcAlt'  : tnpSamples.TnP2017['DY_amcatnlo'].clone(),
    'tagSel' : tnpSamples.TnP2017['DY_madgraph'].clone(),
}

## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.TnP2017['data_Run2017C'] )
samplesDef['data'].add_sample( tnpSamples.TnP2017['data_Run2017D'] )
samplesDef['data'].add_sample( tnpSamples.TnP2017['data_Run2017E'] )
samplesDef['data'].add_sample( tnpSamples.TnP2017['data_Run2017F'] )
