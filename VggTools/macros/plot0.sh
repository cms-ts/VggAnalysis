...
for YEAR in $YEARS; do
  ...
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele.dat\",\"h_Z_ele_met_pt\",\"$VERSION\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele.dat\",\"h_Z_ele_met_phi\",\"$VERSION\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele.dat\",\"h_Z_ele_met_sign\",\"$VERSION\"\)
  ...
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo.dat\",\"h_Z_muo_met_pt\",\"$VERSION\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo.dat\",\"h_Z_muo_met_phi\",\"$VERSION\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo.dat\",\"h_Z_muo_met_sign\",\"$VERSION\"\)
