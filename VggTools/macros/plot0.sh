...
for YEAR in $YEARS; do
  ...
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho0_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho1_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  ...
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho0_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho1_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  ...
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho0_pf_iso_all\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho0_pf_iso_chg\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho1_pf_iso_all\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_ele\",\"h_W_ele_pho1_pf_iso_chg\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho0_pf_iso_all\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho0_pf_iso_chg\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho1_pf_iso_all\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Wgg"$YEAR"_muo\",\"h_W_muo_pho1_pf_iso_chg\",\"$VERSION\",\"$FLAGS\"\)
  ...
  root-6.12 -l -q -b plot0.C+\(\"Zgg"$YEAR"_ele\",\"h_Z_ele_pho0_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Zgg"$YEAR"_ele\",\"h_Z_ele_pho1_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  ...
  root-6.12 -l -q -b plot0.C+\(\"Zgg"$YEAR"_muo\",\"h_Z_muo_pho0_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot0.C+\(\"Zgg"$YEAR"_muo\",\"h_Z_muo_pho1_jet0_dR\",\"$VERSION\",\"$FLAGS\"\)
