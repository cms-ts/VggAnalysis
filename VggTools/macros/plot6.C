...
int plot6(string plot="", string title="", string version="v00", string options="default") {
      ...
      if (h_xsec_rec["reference"]) {
        if (flags[i].find("reference") != string::npos) {
          ...
          h_xsec_rec_errors_m->SetBinContent(i+1, -100. * TMath::Sqrt((TMath::Power(xsec_stat_data, 2) - TMath::Power(xsec_stat_data_ref, 2))/(1.1 * 1.1 - 1.)) / xsec_data_ref);
                   ...
                   flags[i].find("jet_misid_sherpa") != string::npos ||
  ...
  if (h_xsec_rec["xsec_syst_wg"]) {
    double xval_stat = 0.;
    double xval = h_xsec_rec["xsec_syst_wg"]->IntegralAndError(0, h_xsec_rec["xsec_syst_wg"]->GetNbinsX()+1, xval_stat, "width");
    xval = xval - xsec_data_ref;
    xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(xval_stat, 2) - TMath::Power(xsec_stat_data_ref, 2))));
    errors_tot["xsec_syst_wg"] = xval;
  }

  if (h_xsec_rec["xsec_syst_zg"]) {
    double xval_stat = 0.;
    double xval = h_xsec_rec["xsec_syst_zg"]->IntegralAndError(0, h_xsec_rec["xsec_syst_zg"]->GetNbinsX()+1, xval_stat, "width");
    xval = xval - xsec_data_ref;
    xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(xval_stat, 2) - TMath::Power(xsec_stat_data_ref, 2))));
    errors_tot["xsec_syst_zg"] = xval;
  }

  if (h_xsec_rec["xsec_syst_others"]) {
    double xval_stat = 0.;
    double xval = h_xsec_rec["xsec_syst_others"]->IntegralAndError(0, h_xsec_rec["xsec_syst_others"]->GetNbinsX()+1, xval_stat, "width");
    xval = xval - xsec_data_ref;
    xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(xval_stat, 2) - TMath::Power(xsec_stat_data_ref, 2))));
    errors_tot["xsec_syst_others"] = xval;
  }
  ...
  if (h_xsec_rec["jet_misid_test"]) {
    double xval_stat = 0.;
    double xval = h_xsec_rec["jet_misid_test"]->IntegralAndError(0, h_xsec_rec["jet_misid_test"]->GetNbinsX()+1, xval_stat, "width");
    xval = xval - xsec_data_ref;
    xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(xval_stat, 2) - TMath::Power(xsec_stat_data_ref, 2))));
    xval = xval / 2.0;
  ...
  if (h_xsec_rec["jet_misid_sherpa"]) {
    double xval_stat = 0.;
    double xval = h_xsec_rec["jet_misid_sherpa"]->IntegralAndError(0, h_xsec_rec["jet_misid_sherpa"]->GetNbinsX()+1, xval_stat, "width");
    xval = xval - xsec_data_ref;
    xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(xval_stat, 2) - TMath::Power(xsec_stat_data_ref, 2))));
    xval = xval / 2.0;
    errors_tot["jet_misid_sherpa"] = xval;
  }
  ...
  for (int i = 0; i < h_xsec_rec["reference"]->GetNbinsX()+2; i++) {
    ...
    if (h_xsec_rec["xsec_syst_wg"]) {
      double xval = fabs(h_xsec_rec["xsec_syst_wg"]->GetBinContent(i) - h_xsec_rec["reference"]->GetBinContent(i));
      xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(h_xsec_rec["xsec_syst_wg"]->GetBinError(i), 2) - TMath::Power(h_xsec_rec["reference"]->GetBinError(i), 2))));
      xval = xval * h_xsec_rec["reference"]->GetBinWidth(i);
      errors["xsec_syst_wg"].push_back(xval);
    }

    if (h_xsec_rec["xsec_syst_zg"]) {
      double xval = fabs(h_xsec_rec["xsec_syst_zg"]->GetBinContent(i) - h_xsec_rec["reference"]->GetBinContent(i));
      xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(h_xsec_rec["xsec_syst_zg"]->GetBinError(i), 2) - TMath::Power(h_xsec_rec["reference"]->GetBinError(i), 2))));
      xval = xval * h_xsec_rec["reference"]->GetBinWidth(i);
      errors["xsec_syst_zg"].push_back(xval);
    }

    if (h_xsec_rec["xsec_syst_others"]) {
      double xval = fabs(h_xsec_rec["xsec_syst_others"]->GetBinContent(i) - h_xsec_rec["reference"]->GetBinContent(i));
      xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(h_xsec_rec["xsec_syst_others"]->GetBinError(i), 2) - TMath::Power(h_xsec_rec["reference"]->GetBinError(i), 2))));
      xval = xval * h_xsec_rec["reference"]->GetBinWidth(i);
      errors["xsec_syst_others"].push_back(xval);
    }
    ...
    if (h_xsec_rec["jet_misid_test"]) {
      double xval = fabs(h_xsec_rec["jet_misid_test"]->GetBinContent(i) - h_xsec_rec["reference"]->GetBinContent(i));
      xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(h_xsec_rec["jet_misid_test"]->GetBinError(i), 2) - TMath::Power(h_xsec_rec["reference"]->GetBinError(i), 2))));
      xval = xval * h_xsec_rec["reference"]->GetBinWidth(i);
      xval = xval / 2.0;
    ...
    if (h_xsec_rec["jet_misid_sherpa"]) {
      double xval = fabs(h_xsec_rec["jet_misid_sherpa"]->GetBinContent(i) - h_xsec_rec["reference"]->GetBinContent(i));
      xval = TMath::Sqrt(TMath::Max(0., TMath::Power(xval, 2) - TMath::Abs(TMath::Power(h_xsec_rec["jet_misid_sherpa"]->GetBinError(i), 2) - TMath::Power(h_xsec_rec["reference"]->GetBinError(i), 2))));
      xval = xval * h_xsec_rec["reference"]->GetBinWidth(i);
      xval = xval / 2.0;
      errors["jet_misid_sherpa"].push_back(xval);
    }
  ...
  if (errors["xsec_syst_wg"].size()) labels.push_back("xsec_syst_wg");
  if (errors["xsec_syst_zg"].size()) labels.push_back("xsec_syst_zg");
  ...
  if (errors["jet_misid_sherpa"].size()) labels.push_back("jet_misid_sherpa");
  ...
  if (tmp_title == "h_WGG_ele_pho1_eta" || tmp_title == "h_WGG_muo_pho1_eta") {
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / d#sigma_{i#etai#eta}^{#gamma_{1}} [pb]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dIso_{all}^{#gamma_{2}} [pb]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / d#DeltaR^{#gamma_{1}#gamma_{2}} [pb]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM_{T} [pb/GeV]");
  } else if (tmp_title == "h_ZGG_ele" || tmp_title == "h_ZGG_muo") {
    h_ratio_gen->GetXaxis()->SetTitle("M_{ll} [GeV]");
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM_{ll} [pb/GeV]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM^{l_{1}#gamma_{1}#gamma_{2}} [pb/GeV]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM^{l#gamma_{2}} [pb/GeV]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM^{l#gamma_{1}#gamma_{2}} [pb/GeV]");
    ...
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / dM^{l_{1}l_{2}#gamma_{1}#gamma_{2}} [pb/GeV]");
  } else {
    tmp_title.erase(0, 2);
    h_ratio_gen->GetXaxis()->SetTitle(tmp_title.c_str());
    h_xsec_mc_gen["reference"]->GetYaxis()->SetTitle("d#sigma / d?");
  }
...
int main(int argc, char *argv[]) {
  ...
  vector<string> args = {"plot6.exe", "", "", "v00", "default"};

  for (uint i = 0; i < argc; i++) args[i] = argv[i];

  cout << "Processing plot6.C(\"" << args[1] << "\",\""
                                  << args[2] << "\",\""
                                  << args[3] << "\",\""
                                  << args[4] << "\")..." << endl;

  return plot6(args[1], args[2], args[3], args[4]);
