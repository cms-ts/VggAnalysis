...
for YEAR in $YEARS; do
  ...
  root-6.12 -l -q -b plot4.C+\(\"Wgg"$YEAR"_ele\",\"h_WGG_ele_ele0_pho0_pho1\",\"$VERSION\",\"$FLAGS\"\)
  root-6.12 -l -q -b plot4.C+\(\"Wgg"$YEAR"_muo\",\"h_WGG_muo_muo0_pho0_pho1\",\"$VERSION\",\"$FLAGS\"\)
