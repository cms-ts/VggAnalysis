...
TH3D* rebin(TH3D* old) {
  ...
  if (name.find("WGG_ele_pho0_pho1_pt_") != string::npos || name.find("WGG_muo_pho0_pho1_pt_") != string::npos ||
      name.find("ZGG_ele_pho0_pho1_pt_") != string::npos || name.find("ZGG_muo_pho0_pho1_pt_") != string::npos) {
