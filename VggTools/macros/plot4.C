...
void plot4(string plot="", string title="", string version="v00", string options="", string flag="reference"){
  ...
  if (options.find("identity0") != string::npos || options.find("identity1") != string::npos || options.find("closure0") != string::npos || options.find("closure1") != string::npos || options.find("validation") != string::npos) {
  ...
  if (plot.find("2016") != string::npos || plot.find("Run2") != string::npos) {
    ...
    } else if (flag == "jet_misid_qcd") {
      file_matrix_2016 = new TFile(("html/" + version + "/" + flag + "/2016.matrix/root/h_WG_muo_pho0_pt" + title_tmp + ".root").c_str());
    } else {
  ...
  if (plot.find("2017") != string::npos || plot.find("Run2") != string::npos) {
    ...
    if (flag == "jet_misid_test") {
      ...
      file_matrix_2017 = new TFile(("html/" + version + "/" + flag + "/2017.matrix/root/h_WG_muo_pho0_pt" + title_tmp + ".root").c_str());
    } else {
  ...
  if (plot.find("2018") != string::npos || plot.find("Run2") != string::npos) {
    ...
    if (flag == "jet_misid_test") {
      ...
      file_matrix_2018 = new TFile(("html/" + version + "/" + flag + "/2018.matrix/root/h_WG_muo_pho0_pt" + title_tmp + ".root").c_str());
    } else {
